                    ...
                    <div class="col-12 mainNavCol">
                        ...
                        <div class="right-side fw-700 mainNavCol">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-5">
                                                    <div class="ex-collection-box h-100">
                                                        <a href="#">
                                                            <img src="{{ asset('images/nav-1.jpg') }}"
                            ...
                            <div class="user-details p-relative">
                                <a href="#" class="text-light-white fw-500"> <img
                                        src="{{ asset('images/user-1.png') }}" class="rounded-circle" alt="userimg" />
                                    <span>Hi, Kate</span> </a>
                            ...
                            <div class="cart-btn notification-btn">
                                ...
                                <div class="notification-dropdown">
                                    <div class="product-detail">
                                        <a href="#">
                                            <div class="img-box">
                                                <img src="{{ asset('images/shop-1.png') }}" class="rounded"
                                                    alt="image" />
                                            </div>
                                        ...
                                        <div class="card-body no-padding">
                                            <div class="cat-product-box">
                                                <div class="cat-product">
                                                    ...
                                                    <div class="price"><a href="#" class="text-dark-white fw-500"> $2.25
                                                        </a></div>
                                                </div>
                                            </div>
                                            <div class="cat-product-box">
                    ...
                    <div class="col-sm-12 mobile-search">
                        <div class="mobile-address">
                            <a href="#" class="delivery-add" data-toggle="modal" data-target="#address-box"> <span
                                    class="address">Brooklyn, NY</span> </a>
                        </div>
                            ...
                            <div class="btns">
                                <div class="filter-btn">
                                    <button type="button"><i
                                            class="fas fa-sliders-h text-light-green fs-18"></i></button> <span
                                        class="text-light-green">Sort</span>
                                </div>
                                <div class="filter-btn">
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-4 col-6 mb-sm-20">
                    <div class="icon-box">
                        ...
                        <span class="text-custom-white">Support lots<br />
                            of Payments</span>
                    </div>
                </div>
                <div class="col-md-2 col-sm-4 col-6 mb-sm-20">
    ...
    <footer class="section-padding bg-light-theme pt-0 u-line bg-black">
        <div class="u-line instagram-slider swiper-container swiper-container-initialized swiper-container-horizontal">
            <ul class="hm-list hm-instagram swiper-wrapper"
                ...
                <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="1"
                    style="width: 200px">
                    <a href="#"><img src="{{ asset('images/insta-1.jpg') }}" alt="instagram" /></a>
                </li>
                <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active"
                    data-swiper-slide-index="2" style="width: 200px">
                    <a href="#"><img src="{{ asset('images/insta-2.jpg') }}" alt="instagram" /></a>
                </li>
                <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="3"
                    style="width: 200px">
                    <a href="#"><img src="{{ asset('images/insta-4.jpg') }}" alt="instagram" /></a>
                </li>
            </ul>
            ...
            <div class="row">
                ...
                <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                    <div class="footer-links">
                        ...
                        <div class="appimg">
                            <a href="#">
                                <img src="{{ asset('images/playstore.jpg') }}" class="img-fluid" alt="app logo" />
                            </a>
                        </div>
                        <div class="appimg">
                            <a href="#">
                                <img src="{{ asset('images/appstore.jpg') }}" class="img-fluid" alt="app logo" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="copyright-text">
                        <span class="text-light-white">© <a href="#" class="text-light-white">Slidesigma</a> - 2019 |
