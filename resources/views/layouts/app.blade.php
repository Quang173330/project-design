    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-12 mainNavCol">
                                ...
                                <form class="main-search search-form full-width">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-5">
                                            <a href="#" class="delivery-add p-relative">
                            ...
                            <div class="right-side fw-700 mainNavCol">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div class="menu-style">
                                                                    ...
                                                                    <ul>
                                                                        <li class="active"><a href="index.html" class="text-light-white fw-500">Landing Page</a></li>
                                                                        <li><a href="homepage-1.html" class="text-light-white fw-500">Home Page 1</a></li>
                                                                        <li><a href="homepage-2.html" class="text-light-white fw-500">Home Page 2</a></li>
                                                                        <li><a href="homepage-3.html" class="text-light-white fw-500">Home Page 3</a></li>
                                                                        <li><a href="homepage-4.html" class="text-light-white fw-500">Home Page 4</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div class="menu-style">
                                                                    ...
                                                                    <ul>
                                                                        <li><a href="blog.html" class="text-light-white fw-500">Blog Grid View</a></li>
                                                                        <li><a href="blog-style-2.html" class="text-light-white fw-500">Blog Grid View 2</a></li>
                                                                        <li><a href="blog-details.html" class="text-light-white fw-500">Blog Details</a></li>
                                                                        <li><a href="ex-deals.html" class="text-light-white fw-500">Ex Deals</a></li>
                                                                        <li><a href="about.html" class="text-light-white fw-500">About Us</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div class="menu-style">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="restaurant-style-1.html" class="text-light-white fw-500">Restaurant 1</a></li>
                                                                        <li><a href="restaurant-style-2.html" class="text-light-white fw-500">Restaurant 2</a></li>
                                                                        <li><a href="add-restaurant.html" class="text-light-white fw-500">Add Restaurant</a></li>
                                                                        <li><a href="list-view.html" class="text-light-white fw-500">List View</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div class="menu-style">
                                                                    ...
                                                                    <ul>
                                                                        <li><a href="login.html" class="text-light-white fw-500">Login</a></li>
                                                                        <li><a href="register.html" class="text-light-white fw-500">Sign-up</a></li>
                                                                        <li><a href="checkout.html" class="text-light-white fw-500">Checkout</a></li>
                                                                        <li><a href="order-details.html" class="text-light-white fw-500">Order Details</a></li>
                                                                        <li><a href="geo-locator.html" class="text-light-white fw-500">Geo Locator</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="mobile-search">
                                    <a href="#" data-toggle="modal" data-target="#search-box"> <i class="fas fa-search"></i> </a>
                                </div>
                                <!-- mobile search -->
                                <!-- user account -->
                                <div class="user-details p-relative">
                                    <a href="#" class="text-light-white fw-500"> <img src="images/user-1.png" class="rounded-circle" alt="userimg" /> <span>Hi, Kate</span> </a>
                                        ...
                                        <div class="user-footer">
                                            ...
                                            <a href="#">
                                                <form action="{{ route('logout') }}" method="post">
                                                    @csrf
                                                    <input id="logout-input" type="submit" value="Sign Out">
                                                </form>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="cart-btn cart-dropdown">
                                    ...
                                    <div class="cart-detail-box">
                                        <div class="card">
                                            ...
                                            <div class="card-body no-padding">
                                                <div class="cat-product-box">
                                                    <div class="cat-product">
                                                        ...
                                                        <div class="price"><a href="#" class="text-dark-white fw-500"> $2.25 </a></div>
                                                    </div>
                                                </div>
                                                <div class="cat-product-box">
                                                    <div class="cat-product">
                                            ...
                                            <div class="card-footer padding-15"><a href="checkout.html" class="btn-first green-btn text-custom-white full-width fw-500">Proceed to Checkout</a></div>
                                        </div>
                                    </div>
                                </div>
                                <!-- user cart -->
                        ...
                        <div class="col-sm-12 mobile-search">
                            <div class="mobile-address">
                                <a href="#" class="delivery-add" data-toggle="modal" data-target="#address-box"> <span class="address">Brooklyn, NY</span> </a>
                            </div>
                            <div class="sorting-addressbox">
                                <span class="full-address text-light-green">Brooklyn, NY 10041</span>
                                <div class="btns">
                                    <div class="filter-btn">
                                        <button type="button"><i class="fas fa-sliders-h text-light-green fs-18"></i></button> <span class="text-light-green">Sort</span>
                                    </div>
                                    <div class="filter-btn">
                                        <button type="button"><i class="fas fa-filter text-light-green fs-18"></i></button> <span class="text-light-green">Filter</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-2 col-sm-4 col-6 mb-sm-20">
                        <div class="icon-box">
                            <span class="text-light-green"><i class="flaticon-credit-card-1"></i></span>
                    ...
                    <div class="col-md-2 col-sm-4 col-6">
                        <div class="icon-box">
                            <span class="text-light-green"><i class="flaticon-app-file-symbol"></i></span>
        ...
        <footer class="section-padding bg-light-theme pt-0 u-line bg-black">
            <div class="u-line instagram-slider swiper-container swiper-container-initialized swiper-container-horizontal">
                <ul class="hm-list hm-instagram swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-1200px, 0px, 0px)">
                    <li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" style="width: 200px">
                        <a href="#"><img src="images/insta-5.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="5" style="width: 200px">
                        <a href="#"><img src="images/insta-6.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="6" style="width: 200px">
                        <a href="#"><img src="images/insta-7.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="7" style="width: 200px">
                        <a href="#"><img src="images/insta-8.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide" data-swiper-slide-index="0" style="width: 200px">
                        <a href="#"><img src="images/insta-3.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide swiper-slide-prev" data-swiper-slide-index="1" style="width: 200px">
                        <a href="#"><img src="images/insta-1.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide swiper-slide-active" data-swiper-slide-index="2" style="width: 200px">
                        <a href="#"><img src="images/insta-2.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide swiper-slide-next" data-swiper-slide-index="3" style="width: 200px">
                        <a href="#"><img src="images/insta-4.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide" data-swiper-slide-index="4" style="width: 200px">
                        <a href="#"><img src="images/insta-5.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide" data-swiper-slide-index="5" style="width: 200px">
                        <a href="#"><img src="images/insta-6.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide" data-swiper-slide-index="6" style="width: 200px">
                        <a href="#"><img src="images/insta-7.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide" data-swiper-slide-index="7" style="width: 200px">
                        <a href="#"><img src="images/insta-8.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" style="width: 200px">
                        <a href="#"><img src="images/insta-3.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="1" style="width: 200px">
                        <a href="#"><img src="images/insta-1.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="2" style="width: 200px">
                        <a href="#"><img src="images/insta-2.jpg" alt="instagram" /></a>
                    </li>
                    <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="3" style="width: 200px">
                        <a href="#"><img src="images/insta-4.jpg" alt="instagram" /></a>
                    </li>
                </ul>
                ...
                <div class="row">
                    <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                        <div class="footer-contact">
                            ...
                            <ul>
                                <li class="fw-600"><span class="text-light-white">Call Us</span> <a href="tel:" class="text-custom-white">+(347) 123 456 789</a></li>
                                <li class="fw-600"><span class="text-light-white">Email Us</span> <a href="mailto:" class="text-custom-white">demo@domain.com</a></li>
                                <li class="fw-600"><span class="text-light-white">Join our twitter</span> <a href="#" class="text-custom-white">@quickmunch</a></li>
                                <li class="fw-600"><span class="text-light-white">Join our instagram</span> <a href="#" class="text-custom-white">@quickmunch</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <ul>
                                <li><a href="#" class="text-light-white fw-600">About Us</a></li>
                                <li><a href="#" class="text-light-white fw-600">Blog</a></li>
                                <li><a href="#" class="text-light-white fw-600">Socialize</a></li>
                                <li><a href="#" class="text-light-white fw-600">Quickmunch</a></li>
                    ...
                    <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <ul>
                                ...
                                <li><a href="#" class="text-light-white fw-600">Find restaurant</a></li>
                                <li><a href="#" class="text-light-white fw-600">Login</a></li>
                                <li><a href="#" class="text-light-white fw-600">Track order</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <ul>
                                <li><a href="#" class="text-light-white fw-600">Suggest an Idea</a></li>
                                <li><a href="#" class="text-light-white fw-600">Be a Partner restaurant</a></li>
                                <li><a href="#" class="text-light-white fw-600">Create an Account</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="copyright-text">
                            <span class="text-light-white">© <a href="#" class="text-light-white">Slidesigma</a> - 2019 | All Right Reserved</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Munch Box Js -->
        <script src="js/quickmunch.js"></script>
        <!-- /Place all Scripts Here -->
    </body>
</html>
