                    ...
                    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px)">
                        <div class="swiper-slide swiper-slide-active" style="width: 142.5px; margin-right: 40px">
                            <a href="restaurant.html" class="categories">
                                <div class="icon icon-parent text-custom-white bg-light-green"><i class="fas fa-map-marker-alt"></i></div>
                        ...
                        <div class="product-box mb-xl-20">
                            ...
                            <div class="product-caption">
                                <div class="title-box">
                                    ...
                                    <div class="tags"><span class="text-custom-white rectangle-tag bg-yellow"> 3.1 </span></div>
                                </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="banner-adv2 mb-xl-20">
                    ...
                    <span class="text">Unlimited Free Delivery with. <img src="images/tag.jpg" alt="logo" /> <a href="restaurant.html" class="btn-second btn-submit">Try 30 Days FREE</a></span>
